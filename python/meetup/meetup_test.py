...
class MeetupTest(unittest.TestCase):
    def test_monteenth_of_may_2013(self):
        self.assertEqual(meetup(2013, 5, "teenth", "Monday"),
                         date(2013, 5, 13))
    ...
    def test_tuesteenth_of_april_2013(self):
        self.assertEqual(meetup(2013, 4, "teenth", "Tuesday"),
                         date(2013, 4, 16))

    def test_tuesteenth_of_august_2013(self):
        self.assertEqual(meetup(2013, 8, "teenth", "Tuesday"),
                         date(2013, 8, 13))
    ...
    def test_friteenth_of_april_2013(self):
        self.assertEqual(meetup(2013, 4, "teenth", "Friday"),
                         date(2013, 4, 19))

    def test_friteenth_of_august_2013(self):
        self.assertEqual(meetup(2013, 8, "teenth", "Friday"),
                         date(2013, 8, 16))

    def test_friteenth_of_september_2013(self):
        self.assertEqual(meetup(2013, 9, "teenth", "Friday"),
                         date(2013, 9, 13))
    ...
    def test_sunteenth_of_may_2013(self):
        self.assertEqual(meetup(2013, 5, "teenth", "Sunday"),
                         date(2013, 5, 19))

    def test_sunteenth_of_june_2013(self):
        self.assertEqual(meetup(2013, 6, "teenth", "Sunday"),
                         date(2013, 6, 16))

    def test_sunteenth_of_october_2013(self):
        self.assertEqual(meetup(2013, 10, "teenth", "Sunday"),
                         date(2013, 10, 13))
    ...
    def test_first_thursday_of_october_2013(self):
        self.assertEqual(meetup(2013, 10, "1st", "Thursday"),
                         date(2013, 10, 3))
    ...
    def test_fourth_wednesday_of_july_2013(self):
        self.assertEqual(meetup(2013, 7, "4th", "Wednesday"),
                         date(2013, 7, 24))

    def test_fourth_wednesday_of_august_2013(self):
        self.assertEqual(meetup(2013, 8, "4th", "Wednesday"),
                         date(2013, 8, 28))
    ...
    def test_fourth_thursday_of_october_2013(self):
        self.assertEqual(meetup(2013, 10, "4th", "Thursday"),
                         date(2013, 10, 24))
    ...
    def test_last_wednesday_of_july_2013(self):
        self.assertEqual(meetup(2013, 7, "last", "Wednesday"),
                         date(2013, 7, 31))

    def test_last_wednesday_of_august_2013(self):
        self.assertEqual(meetup(2013, 8, "last", "Wednesday"),
                         date(2013, 8, 28))

    def test_last_thursday_of_september_2013(self):
        self.assertEqual(meetup(2013, 9, "last", "Thursday"),
                         date(2013, 9, 26))

    def test_last_thursday_of_october_2013(self):
        self.assertEqual(meetup(2013, 10, "last", "Thursday"),
                         date(2013, 10, 31))

    def test_last_friday_of_november_2013(self):
        self.assertEqual(meetup(2013, 11, "last", "Friday"),
                         date(2013, 11, 29))

    def test_last_friday_of_december_2013(self):
        self.assertEqual(meetup(2013, 12, "last", "Friday"),
                         date(2013, 12, 27))

    def test_last_saturday_of_january_2013(self):
        self.assertEqual(meetup(2013, 1, "last", "Saturday"),
                         date(2013, 1, 26))

    def test_last_saturday_of_february_2013(self):
        self.assertEqual(meetup(2013, 2, "last", "Saturday"),
                         date(2013, 2, 23))
    ...
    def test_last_wednesday_of_february_2012(self):
        self.assertEqual(meetup(2012, 2, "last", "Wednesday"),
                         date(2012, 2, 29))

    def test_last_wednesday_of_december_2014(self):
        self.assertEqual(meetup(2014, 12, "last", "Wednesday"),
                         date(2014, 12, 31))
